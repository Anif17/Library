...
<body style="background-color: rgb(198,198,198);">
    ...
    //Select Database
    $sql = "SELECT*FROM bk_borrow WHERE status = 'pending'";
    $result = $mysqli->query($sql)
    ?>

    <h1 align="center" style="padding-top: 7%;"><span class="badge badge-info">RESERVATION LIST</span> </h1>
            ...
            <tbody>
                ...
                ?>
                        <tr>
                            ...
                            <td>
                                <a href="approve_fun.php?edit=1&stu_id=<?php echo $row['stu_id']; ?>&bk_isbn=<?php echo $row['bk_isbn']; ?>">
