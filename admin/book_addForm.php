...
<body>
    ...
    <div class="container">
        <div align="center" style="font-size: 40px;"><span class="badge badge-info">INSERT BOOK</span>
        </div>
        <div class="content">
            <form action="book_insert.php" method="POST">
                <div class="user-details">
                    <div class="input-box">
                        ...
                        <input type="text" placeholder="Enter ID" name="bkIsbn" required>
                    </div>
                    <div class="input-box">
                        <span class="details">BOOK TITLE</span>
                        <input type="text" placeholder="Enter book ISBN" name="bkTitle" required>
                    </div>
                    <div class="input-box">
                        <span class="details">BOOK PAGE</span>
                        <input type="number" placeholder="Enter book page" name="bkPage" required>
                    </div>
                    <div class="input-box">
                        <span class="details">BOOK RATING</span>
                        <input type="number" placeholder="Enter book rating" name="bkRating" required>
                    </div>
                    <div class="input-box">
                        <span class="details">BOOK PUBLISHED DATE</span>
                        <input type="date" name="bkPub" required>
                    </div>
                    <div class="input-box">
                        <span class="details">BOOK PUBLISHER ID</span>
                        <input type="text" placeholder="Enter book publisher id" name="pubID" required>
                    </div>
                </div>
                <div class="button">
