...
<body>
    ...
    $id = $_GET['id'];
    $sql = "SELECT*FROM bk_borrow where borrowID='$id'";
    ...
    while ($row = $result->fetch_assoc()) {
        ...
        $stu_id = $row['stu_id'];
        $bk_isbn = $row['bk_isbn'];
        $tk_date = $row['takenDate'];
        $br_date = $row['broughtDate'];
    }
    ...
    <div class="container">
        ...
        <div class="content">
            <form action="edit_brFun.php" method="POST">
                <div class="user-details">
                    <div class="input-box">
                        <span class="details">Borrow ID</span>
                        <input type="text" placeholder="Borrow ID" name="brID" value="<?php echo $br_id; ?>" required readonly>
                    </div>
                    <div class="input-box">
                        <span class="details">Student ID</span>
                        <input type="text" placeholder="Enter ID" name="stuID" value="<?php echo $stu_id; ?>" required>
                    </div>
                    <div class="input-box">
                        <span class="details">BOOK ISBN</span>
                        <input type="text" placeholder="Enter book ISBN" name="bookIsbn" value="<?php echo $bk_isbn; ?>" required>
                    </div>
                    <div class="input-box">
                        <span class="details">TAKEN DATE</span>
                        <input type="date" name="takenDate" value="<?php echo $tk_date; ?>" required>
                    </div>
                    <div class="input-box">
                        <span class="details">BROUGHT DATE</span>
                        <input type="date" name="broughtDate" value="<?php echo $br_date; ?>" required>
                    </div>
                    <div class="input-box">
