...
<body style="background-color: rgb(198,198,198);">
    ...
    //Select Database
    $sql = "SELECT*FROM bk_borrow";
    $result = $mysqli->query($sql)
    ?>

    <h1 align="center" style="padding-top: 7%;"><span class="badge badge-info">EDIT BORROW</span> </h1>
        ...
        <div align="center" style="padding-top: 2%;">
            ...
            <div class="col-md-8">
                <div class="search">
                    ...
                    <form name="form1" method="post" action="borrow_Funsearch.php">
            ...
            <tbody>
                ...
                ?>
                        <tr>
                            ...
                            <td><a href="edit_borrowForm.php?edit=1&id=<?php echo $row['borrowID']; ?>"><img src="icon/edit_icon.ico" alt="edit" width="40px"> <span>Edit</span></a></td>
                            <td><a href="borrow_delete.php?deleted=1&id=<?php echo $row['borrowID']; ?>"><img src="icon/delete_icon.ico" alt="delete" width="40px"> <span>Delete</span></a></td>
                        </tr>
