...
<body style="background-color: rgb(198,198,198);">
    ...
    //Select Database
    $sql = "SELECT*FROM tb_contact WHERE id_contact LIKE '%$search%' ORDER BY id_contact ASC";
    $result = $mysqli->query($sql)
    ?>

    <h1 align="center" style="padding-top: 7%;"><span class="badge badge-info">CONTACT US LIST</span> </h1>
        ...
        <div align="center" style="padding-top: 2%;">
            ...
            <div class="col-md-8">
                <div class="search">
                    ...
                    <form name="form1" method="post" action="comment_search.php">
            ...
            <tbody>
                ...
                ?>
                        <tr>
                            ...
                            <td><?php echo $row['course_contact']; ?></td>
                            <td><?php echo $row['comment_contact']; ?></td>
                        </tr>
