...
if (mysqli_query($conn, "INSERT INTO bk_borrow(stu_id,bk_isbn,takenDate,broughtDate,status) VALUES ('$stu_id','$bk_isbn','$tk_date','$br_date','pending')")) {
    echo '<script>alert("Success Insert")</script>';
    header('Refresh:0; borrow.php');
    die();
} else {
