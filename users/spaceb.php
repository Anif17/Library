...
<body>
    <div class="banner">
        ...
        <div>
            ...
            $id = $_SESSION['stud_id'];
            //Select Database
            $sql = "SELECT*FROM bk_borrow WHERE stu_id='$id'";
            $result = $mysqli->query($sql)
            ?>

            <h1 align="center" style="padding-top: 3%;"><span class="badge badge-info">SPACE BOOKING LIST</span> </h1>
                    ...
                    <tbody>
                        ...
                        ?>
                                <tr>
                                    ...
                                    <td>
                                        <span class="badge badge-success" style="font-size: 17px;"><?php echo $row['status']; ?>
                                    </td>
