...
<body>
    <div class="banner">
        ...
        //Select Database
        $sql = "SELECT*FROM tb_book ORDER BY bk_title ASC";
        $result = $mysqli->query($sql)
        ?>


        <h1 align="center" style="padding-top: 3%;"><span class="badge badge-info">LIST OF BOOKS PERPUSTAKAAN TUN DR. ISMAIL</span> </h1>

        <div class="tm-hero d-flex justify-content-center align-items-center">
            <form class="d-flex tm-search-form" name="form1" method="post" action="searchBook.php">
                <input class="form-control tm-search-input" type="search" placeholder="Search using ID.." aria-label="Search" name="txtSearch">
